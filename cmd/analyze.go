...
func newAnalyzeCommand() *cobra.Command {
	...
	flags.StringVarP(&analyzeArgs.OutputFile, common_options.ArgOutputFile, "o", "", "output file, defaults to stdout")
	flags.StringVarP(&analyzeArgs.ErrorFile, common_options.ArgErrorFile, "e", "error.log", "error log path")
